...
class ImageProcessor:
    ...
    def extract_faces(self, face_cascade_path: str, input_image: Optional[np.ndarray] = None) -> list:
        """
...
if __name__ == '__main__':
    ...
    for image_resource in images:
        ...
        extracted_faces = image_processor.extract_faces(fc_path)

        for idx, face in enumerate(extracted_faces):
            # Step 2: Align face using detected eyes
            aligned = image_processor.align_face_by_eyes(eye_path, input_image=face)
